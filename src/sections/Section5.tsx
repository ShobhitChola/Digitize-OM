        ...
        <section className="py-24">
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:pt-12">
                    <div>
                        <h2 className="text-4xl font-semibold text-center mt-6">Increase conversions with professional</h2>
                    ...
                    <div className="flex justify-center items-center w-full">
                        <div className="relative w-full max-w-xs sm:max-w-lg md:max-w-xl lg:max-w-xl xl:max-w-2xl h-auto rounded-3xl">
                            <Image
                                src={web_image}
                                alt="Email Marketing"
