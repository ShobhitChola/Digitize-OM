        ...
        <section className="py-4 lg:py-8 fixed w-full top-0 z-50">
            <div className="container max-w-6xl">
                <div className="border border-black/20 rounded-[27px] md:rounded-full bg-black/10 backdrop-blur">
                    <div className="grid grid-cols-2 lg:grid-cols-2 p-2 px-4 md:pr-2 items-center">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <Link href="/contact">
                                <Button variant="primary" className="hidden md:inline-flex items-center">Create Ads</Button>
                            </Link>
                        </div>
                    </div>
                    <AnimatePresence>
