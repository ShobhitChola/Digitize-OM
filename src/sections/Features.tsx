...
export default function Features() {
    return <section className="py-24">
        <div className="container">
            ...
            <h2 className="text-6xl font-medium text-center mt-6">What would you like <br /> the <span className="text-[#1A73E8]">Power</span> to do</h2>
            <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                <FeatureCard title="Increase Sales" description="Move customers through your sales funnel, from website to purchase" className="md:col-span-2 lg:col-span-1 ">
            ...
            <div className="mt-8 flex flex-wrap gap-3 justify-center">
                {features.map((feature) => (
                    <div key={feature} className="bg-black/15 border border-black/10 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center">
                        <span className="bg-[#1A73E8] text-neutral-950 size-5 rounded-full inline-flex items-center justify-center text-xl">&#10038;</span>
